...
char yfs[50] = "/storage-home/x/xm14/comp421/3_2/yfs"; //should point to YOUR YFS
char test_dir[50] = "/storage-home/x/xm14/comp421/3_2/tests/"; // should point to YOUR test directory
...
test_result run_test(func_ptr test) {
	...
	// Increment the c_item_num of tests we have run
...
test_result* all_tests() {
	...
	// Set the c_item_num of tests that will be run
